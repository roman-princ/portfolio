        ...
        <div className="hidden lg:block relative">
          ...
          <div className="space-y-16">
            {EXPERIENCE.map((experience, index) => (
              <DesktopExperienceCard key={experience.id} experience={experience} index={index} />
            ))}
          </div>
        </div>
        ...
        <div className={`${
          ...
          <div className="flex items-start gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-base font-semibold mb-1 truncate">{experience.position}</h3>
              <div className="text-sm font-medium text-blue-600 dark:text-blue-400 mb-1 truncate">{experience.company}</div>
          ...
          <div className="mb-3">
            <ul className="space-y-1">
              {experience.description.slice(0, 2).map((item, itemIndex) => (
                <li key={itemIndex} className="text-xs text-gray-600 dark:text-gray-300 flex items-start gap-1.5">
